...
#define __ROL__(x, y) rotate(x, y, ROT_LEFT)      // Rotate left
#define __ROR__(x, y) rotate(x, y, ROT_RIGHT)      // Rotate right
#endif

#define __ROL__(x, y) _rotl(x,y)//rotate(x, y, ROT_LEFT)      // Rotate left
#define __ROR__(x, y) _rotr(x,y)//rotate(x, y, ROT_RIGHT)      // Rotate right
